...
const EditSkill = () => {
  ...
  useEffect(() => {
    const fetchSkill = async () => {
      try {
        ...
        addToast(t('skills.fetchError'), 'error');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data?.success) {
        addToast(t('skills.updateSuccess'), 'success');
        navigate('/admin/skills');
      }
    } catch (error) {
  ...
  if (fetching) {
    return (
      <AdminPageLayout title={t('skills.edit-skill')} icon={<Award size={24} />}>
        <div className="u-flex u-items-center u-justify-center" style={{ minHeight: '400px' }}>
          <Loader2 className="animate-spin" size={40} color="var(--primary-600)" />
        </div>
      </AdminPageLayout>
    );
  }
  ...
  return (
    <AdminPageLayout
      icon={<Award size={24} />}
      title={t('skills.edit-skill')}
      subtitle={t('skills.editSubtitle')}
      actions={
        <button 
              ...
              <div className="admin-form-section">
                ...
                <div className="admin-form-group">
                  ...
                  <input
                    ...
                    className={`admin-form-control ${errors.name ? 'admin-form-control--error' : ''}`}
